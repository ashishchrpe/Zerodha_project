...
function Hero(){
    return(
        <div className="container"> 
            <div className="row m-5 py-5 text-center">
                <h1 className="fs-2 " style={{color:"rgb(70,70,70)"}}> We pioneered the discount broking model in India. <br/> Now, we are breaking ground with our technology.</h1>
            </div>
            <div className="row border-top pt-5">
                <div className="col-2"></div>
                <div className="col-4 pt-5 text-muted">
